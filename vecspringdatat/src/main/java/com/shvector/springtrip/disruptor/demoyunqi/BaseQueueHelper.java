/**
 * @create 2019-07-13 23:20
 * @desc BaseQueueHelper
 **/
...
public abstract class BaseQueueHelper <D, E extends ValueWrapper<D>, H extends WorkHandler<E>> {
    ...
    public void init() {
        ...
        disruptor = new Disruptor<E>((com.lmax.disruptor.EventFactory<E>) eventFactory(), getQueueSize(), namedThreadFactory, ProducerType.SINGLE, getStrategy());
